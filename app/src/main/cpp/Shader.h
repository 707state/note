...
public:
     ...
     * @param projectionMatrixUniformName The name of your projection matrix uniform
     * @param modelMatrixUniformName The name of your per-model matrix uniform
     * @param colorUniformName The name of your color tint uniform (vec4)
    ...
    /*!
     * Sets the per-model matrix (e.g. rotation/translation/scale) in the shader.
    ...
    /*!
     * Sets the color tint uniform used to tint the textured quad. Pass (1,1,1,1) for no tint.
     */
...
private:
     ...
     * @param modelMatrix the uniform location of the per-model matrix
     * @param color the uniform location of the color tint
     */
    constexpr Shader(
            GLuint program,
            GLint position,
