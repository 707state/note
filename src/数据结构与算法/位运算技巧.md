...
-   [338 比特位统计](#338-比特位统计)
-   [3226
    使两个整数相等的位更改次数](#3226-使两个整数相等的位更改次数)
-   [461 汉明距离](#461-汉明距离)
-   [868 二进制间距](#868-二进制间距)
-   [3211
    生成不含相邻零的二进制字符串](#3211-生成不含相邻零的二进制字符串)
-   [2917
    找出数组中的K-or值](#2917-找出数组中的k-or值)
-   [693 交替位二进制数](#693-交替位二进制数)
-   [1486 数组异或操作](#1486-数组异或操作)
-   [2433
    找出前缀异或的原始数组](#2433-找出前缀异或的原始数组)
-   [1310
    子数组异或查询](#1310-子数组异或查询)
-   [2683
    相邻值的按位异或](#2683-相邻值的按位异或)
-   [2429 最小异或](#2429-最小异或)
-   [2997
    使数组异或和等于K的最少操作次数](#2997-使数组异或和等于k的最少操作次数)
-   [2980
    检查按位或是否存在尾随0](#2980-检查按位或是否存在尾随0)
-   [1318
    或运算的最小翻转次数](#1318-或运算的最小翻转次数)
-   [2419
    按位于最大的最长子数组](#2419-按位于最大的最长子数组)
-   [2401
    最长优雅子数组](#2401-最长优雅子数组)
-   [3171
    找到按位或最接近K的子数组](#3171-找到按位或最接近k的子数组)
-   [1521
    找到最接近目标值的函数值](#1521-找到最接近目标值的函数值)
-   [3158
    求出出现两次数字的XOR值](#3158-求出出现两次数字的xor值)
-   [构造最小位运算数组1](#构造最小位运算数组1)
-   [3191
    使二进制数组全部等于1的最少操作次数1](#3191-使二进制数组全部等于1的最少操作次数1)
-   [3192 使二进制数组全部等于1的最少次数
    2](#3192-使二进制数组全部等于1的最少次数-2)
