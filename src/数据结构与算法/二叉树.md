...
- [863 二叉树中所有距离为 K 的节点](#863-二叉树中所有距离为k的节点)
...
- [270 最接近的二叉搜索树的值](#270-最接近的二叉搜索树值)
- [270 验证二叉搜索树的前序遍历序列](#255-验证二叉搜索树的前序遍历序列)
- [333 最大的二叉搜索树](#333-最大的二叉搜索树)
- [1522 N叉树的直径](#1522-n叉树的直径)
- [1522 N叉数的直径](#1522-n叉树的直径)
    ...
    int diameter(Node* root) {
        ...
        std::function<int(Node*)> height=[&](Node *node)->int{
            ...
            for(auto child: node->children){
                ...
                int distance=maxHeight+maxHeight2;
                treed=max(treed,distance);
            }
            return maxHeight;
        };
        height(root);
